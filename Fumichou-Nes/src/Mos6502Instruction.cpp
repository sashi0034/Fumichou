...
namespace
{
	...
	consteval InstructionSet createSet()
	{
		...
		set[0x4A] = {&op::LSR, &addr::Accumulator, U"LSR ACC"};
		set[0x46] = {&op::LSR, &addr::ZeroPage, U"LSR ZP"};
		set[0x56] = {&op::LSR, &addr::ZeroPageX, U"LSR ZP,X"};
		set[0x4E] = {&op::LSR, &addr::Absolute, U"LSR ABS"};
		set[0x5E] = {&op::LSR, &addr::AbsoluteX, U"LSR ABS,X"};
		...
		set[0x2A] = {&op::ROL, &addr::Accumulator, U"ROL ACC"};
		set[0x26] = {&op::ROL, &addr::ZeroPage, U"ROL ZP"};
		set[0x36] = {&op::ROL, &addr::ZeroPageX, U"ROL ZP,X"};
		set[0x2E] = {&op::ROL, &addr::Absolute, U"ROL ABS"};
		set[0x3E] = {&op::ROL, &addr::AbsoluteX, U"ROL ABS,X"};
		set[0x6A] = {&op::ROR, &addr::Accumulator, U"ROR ACC"};
		set[0x66] = {&op::ROR, &addr::ZeroPage, U"ROR ZP"};
		set[0x76] = {&op::ROR, &addr::ZeroPageX, U"ROR ZP,X"};
		set[0x6E] = {&op::ROR, &addr::Absolute, U"ROR ABS"};
		set[0x7E] = {&op::ROR, &addr::AbsoluteX, U"ROR ABS,X"};
